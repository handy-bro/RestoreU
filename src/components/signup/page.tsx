...
const SignUp: React.FC<ApartProps> = ({role}) => {
  ...
  return (
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:bg-boxdark m-10 md:m-50 md:h-500">
        <div className="flex flex-wrap items-center">
          <div className="hidden w-full xl:block xl:w-1/2">
            <div className="px-26 py-17.5 text-center">
              ...
              <p className="2xl:px-20">
                Retrouvez vos pieces perdues grace a 
                RestoreU
              </p>
          ...
          <div className="w-full border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              <span className="mb-1.5 block font-medium">Essayez gratuitement</span>
              ...
              <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-4">
                  ...
                  />
                  {errors.nom && (
                    <small className="text-rose-600 text-sm ">
                      Ce champ est obligatoire *
                    </small>
                  )}

                    <span className="absolute right-4 top-4">
                      <FontAwesomeIcon icon={faUser} width="22" height="22"  opacity={0.5}/>
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <small className="text-rose-600 text-sm ">{emailErr}</small>
                    <span className="absolute right-4 top-4">
                      <FontAwesomeIcon icon={faEnvelope} width="22" height="22"  opacity={0.5}/>
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <FontAwesomeIcon icon={faPhone} width="22" height="22"  opacity={0.5}/>
                    </span>
                  </div>
                </div>
                ...
                <div className="mb-6">
                  ...
                  <div className="relative">
                    ...
                    <span className="absolute right-4 top-4">
                      <FontAwesomeIcon icon={faLock} width="22" height="22" opacity={0.5}/>
                    </span>
                  </div>
                </div>
